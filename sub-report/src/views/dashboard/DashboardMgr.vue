<template>
    <div class="ren-panel">
        <KemPageCard>
            <template slot="header">大屏管理</template>
            ...
            <KemTable
                ...
                <template slot="menuLeft">
                    <el-input v-model="search_report_name" ></el-input>
                </template>
            </KemTable>
...
export default {
    ...
    data(){
        return {
            ...
            column:[
                ...
                {prop:'isDashboard',label:'isDashboard'}
            ],
    ...
    methods:{
        ...
        clickMenuButton({type,row}){
            ...
            if("add" === type){
                this.$router.push({path:"/dashboard/edit/0"})
            }
            else if("del" === type){
                ...
                this.$router.push('/dashboard/edit/' + row.id )
             }
        },
