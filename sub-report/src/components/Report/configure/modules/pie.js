import { getFormated ,itemPoint,setArrayValue} from '@/utils/utils'

import { cloneDeep ,isArray} from 'utils-lite'
...
export const pie = (columns, rows, settings, extra, isRing) => {
  ...
  if(isArray(metrics)) metrics = metrics[0]
  if(isArray(dimension)) dimension = dimension[0]
