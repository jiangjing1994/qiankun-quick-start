import {getFormated, getStackMap} from '../../../../utils/utils'
import {isArray} from 'utils-lite'
import {markLine} from "./generateChart";

function getLineXAxis (args) {
    const { dimension, rows, xAxisName, axisVisible, xAxisType,axisLabelRotate } = args
...
export const line = (columns, rows, settings, extra) => {
    ...
    const { tooltipVisible = false, legendVisible = false, tooltipFormatter } = extra
